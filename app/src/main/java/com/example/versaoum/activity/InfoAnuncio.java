...
public class InfoAnuncio extends AppCompatActivity {
    ...
    private LinearLayout layoutPerfilDestinatarioAnuncio, layoutToolBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras!=null) {
            ...
            if (estado == 1 && !(idUsuario.equals(anuncio.getIdCriador()))) {
                buttonConversar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
            ...
            } else if (estado == 2 && !(idUsuario.equals(anuncio.getIdCriador()))) {
            ...
            imageFoto2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //popUpClass.setarImagem(urlFotos.get(0));
                }
            });
            ...
            referenciaFinal.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(foto!=null){
                        ...
                        Glide.with(InfoAnuncio.this).load(url).into(imageCriadorAnuncio);
                    }else{
